...
public class SObjectTableModel extends AbstractTableModel
{
	...
	/** Obtains the number of rows in the table. This corresponds to the number of
	 ...
	 *  @return a reference to the object stored at the requested position. No validation
	 *  is done so (row,col) MUST be in the correct ranges. */
