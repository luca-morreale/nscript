...
/** A generic extension to NSObject that implements the DMObject interface to make the
 *  object editable by the DMControl-DMView components. This extension will be used
 *  through inheritance by other objects (NSRelation and NSIconic). */
public class NSEditableObject extends NSObject implements DMObject
{
    ...
    /** Selects the object for edition. After calling this method, method isSelected()
     *  will return true. */
    public void select()
    {
	selected = true;
    ...
    /** Removes the selected status, so that edition commands do not affect this object
     *  anymore. */
    ...
    /** Changes the 'Selected' status. If the object was selected, it will become unselected, 
     *  and vice versa. */
    ...
    /** Command to draw itself on a view. Empty implementation, since these class is still
     *  abstract. */
