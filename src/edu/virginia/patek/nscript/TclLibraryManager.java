...
/** Manages the set of opened libraries in the environment. Among other things, the
 *  TclLibraryManager is responsible for verifying unique TclSnippet names to
 *  prevent naming conflicts, verify uniqueness of library names, find a reference, 
 *  and finding a snippet, either by name or entry number. */
public class TclLibraryManager extends Object
{
	 ...
	 *  @return true if the supplied name is being used by any opened snippet, false otherwise. */
	 ...
	 *  @return true if the supplied name is being taken by any of the opened libraries, false
	 *  otherwise. */
	...
	/** Adds a new library using the fileName. This method will try to opened the given
	 *  file, and parse the library from it, creating a new library object, which then will
	 *  be added to the library manager collection.
	 *  @param fileName the file location. 
	 *  @return true if the file was succesfully opened and library correctly parsed, false
	 *  otherwise. */
	 ...
	 *  @return a reference to the library with the requested name, NULL if the name does not
	 *  exist. */
	...
	/** Obtains a snippet by providing the reference to the library, and a reference index
	 *  to the snippen within the library. 
	 *  @param inLibIndex the 0-based index of the library of interest. 
	 *  @param inSnippetIndex the 0-based index of the snippet within the library. 
	 *  @return a reference to the requested snippet if the references are correct, NULL
	 *  otherwise. */
	...
	/** Obtains a snippet by its name. The method will look in every opened library
	 *  for a library, and return a reference to the requested snippet if found. 
