...
public class SObjectBrowser extends JPanel implements ActionListener
{
    ...
    JLabel description;
    /** The name field, where the user sets and edits the name of the selected object. */
    JTextField nameField;
    /** The name label. "Name: " */
    JLabel name;
    /** A drop down index containing the available indices + the 'None' entry. Through
     *  this element, the user can specify if a given object is indexed by a given array. */
    JComboBox arrayIndex;
    /** The attribute table, where the object properties are listed, and the user can 
     *  modify. */
    JTable attrTable;
    /** A reference to the current object being edited. */
    NSObject o = null;
    
    /** The default constructor receives a reference to the current simulation model. */
...
/*	 	arrayIndex . addItemListener( this );*/
    ...
    /** Provides an interface through which the program can advertise changes in the
     *  simulation model. */
    ...
    /** Implements the ActionListener interface by responding to the different actions
     *  the interface elements generate when manipulated by the user. */
