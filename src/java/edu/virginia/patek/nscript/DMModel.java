...
/** Defines an interface to be implemented by objects that want to be
 *  controlled by the DMControl object for visual editing.
 */
public interface DMModel {
  /** Defines the edition mode of the model to be of selection. */
  public static final int SELECT_MODE = 0;
  /** Defines the edition mode of the model to be the creation
   *  of icons (entities).
   */
  ...
  /** Get the objects stored at a given position, assuming an array
   *  or list order.
