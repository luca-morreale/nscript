...
//   Iterator objIter;
  ...
  /** Removes all the arrays stored in the current model. It is used when
   ...
   *  requested index is incorrect, an error message will be generated
   *  at the standard output, and a null object will be returned.
  ...
  /** Returns the i-th object in the simulation script. Notice that
