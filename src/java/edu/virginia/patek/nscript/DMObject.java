 ...
 * DMObject.java
 *
 * Defines DMObject as an interface to be implemented by any objects that wants
 * to act as a part of a model (stored in an object through the
 * interface DMModel).
 *
 * nscript Project
 *
...
public interface DMObject {
  ...
  /** Function to be implemented to set the state of the object as selected.
   *  If isSelected() function is called after a <b>select()</b> statement a
   *  <b>true</b> value is obtained.
   */
  public void select();

  /** Function to be implemented to set the state of the object as unselected.
   *  If isSelected() function is called after a <b>unselect()</b> statement
   *  a <b>false</b> value is obtained.
   */
