...
public class TclPattern extends Object {
  /** A flag that tells if the pattern is conditional
   *  (depends on a value) or not.
   */
  public boolean isConditional;
  /** The pattern is a string with in-lines where the values of attributes
   *  will substitute. For example the string
   *  'set #name# [new Application/TCP]' contains the in-line
   *  'name' that corresponds to the name of the object. When Tcl output is
   *  generated the actual value of the field 'name' substitutes the inline
   *  to produce Tcl code.
   */
  ...
  /** The value of the attribute that triggers the use of the
   *  default pattern.
   */
