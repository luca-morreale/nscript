...
/** Implements the abstract cell behavior by providing a way to edit the cells in the
 *  object browser component where the object attributes are listed. It creates the 
...
public class SObjectCellEditor extends AbstractCellEditor implements TableCellEditor
{
	...
	/** Obtains the value obtained in the current cell. This correponds to the selected
	 *  item number if limited options exist, or the text if it is a free entry field. */
	...
	/** Creates a component to edit a specific cell in the attribute table. This component,
	 *  again, corresponds to a pull down if there are a finite number of options, and a field
	 *  if it is a free entry. 
