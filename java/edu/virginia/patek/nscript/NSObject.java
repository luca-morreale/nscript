...
/** Defines the basic behavior of an object that will be part of a
 *  simulation script.
 */
class NSObject extends Object {
    ...
    /** These method is used when the user erases an array, using the
     *  'Edit array...' option. If the array of the index being erased (aig)
     *  is being used by the object its index should be reset to -1.
     *  Otherwise if the index is adjusted so that the object does not lose
     *  track of its index.
     *
